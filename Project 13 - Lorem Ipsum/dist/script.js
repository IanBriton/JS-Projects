...
const divElement = document.querySelector(".paragraph-content");
...
formContainer.addEventListener("click", (e) => {
  ...
  const random = Math.floor(Math.random() * loremData.length);

  if (isNaN(value) || value < 1 || value > 9) {
    divElement.innerHTML = loremData[random];
  } else {
    let tempText = loremData.slice(0, value);
